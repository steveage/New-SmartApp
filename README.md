...
New-SmartApp is a sample application that demonstrates how to connect the new SmartThings application ecosystem to Azure using ASP.Net Core. Please keep in mind that this is new smart app vs a classic one.
